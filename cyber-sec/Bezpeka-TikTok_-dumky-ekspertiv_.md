...
Звіт організації Internet 2.0, цитований El País, виявив, що TikTok не надає пріоритету конфіденційності користувачів  ([[#^comment-0|Comment Unknown Author 6]]). Джессіка Коупленд, голова практики кібербезпеки та конфіденційності даних у Bond Schoeneck & King PLLC, висловила занепокоєння щодо значного збору даних про геолокацію та інтернет-активність користувачів TikTok, а також щодо потенційних ризиків для інфраструктури компанії  ([[#^comment-0|Comment Unknown Author 9]]). Експертний аналіз свідчить про те, що політика конфіденційності та практики збору даних TikTok є тривожними та потенційно більш інвазивними, ніж можуть очікувати користувачі  ([[#^comment-0|Comment Unknown Author 6]]).

**6.2. Порівняння з іншими платформами соціальних мереж**

Атлантична рада зазначає, що практики збору даних TikTok щодо американських користувачів не виходять за межі загальноприйнятих серед інших компаній соціальних мереж, включаючи Meta та X  ([[#^comment-0|Comment Unknown Author 1]]). Звіт CRS також дійшов висновку, що збір даних TikTok видається порівнянним з іншими платформами соціальних мереж  ([[#^comment-0|Comment Unknown Author 3]]). Опитування Surfshark, згадане ChannelPro Network, виявило проблеми з використанням TikTok, включаючи збір даних без згоди, але також визнає, що Facebook та Instagram залишаються лідерами за обсягом збору даних  ([[#^comment-0|Comment Unknown Author 10]]). Дослідження Incogni, згадане Tom's Guide, показало, що багато платформ соціальних мереж зберігають дані користувачів протягом тривалого періоду після видалення облікових записів, і що період зберігання TikTok насправді коротший, ніж у деяких інших  ([[#^comment-0|Comment Unknown Author 11]]). Хоча збір даних TikTok є значним, експерти часто зазначають, що він не є унікальним або гіршим, ніж у інших великих платформ соціальних мереж, що свідчить про те, що основне занепокоєння полягає в доступності цих даних для китайського уряду, а не в самому обсязі зібраних даних  ([[#^comment-0|Comment Unknown Author 1]]).

**6.3. Заяви TikTok проти експертних висновків**

Існують розбіжності між публічними заявами TikTok щодо його практики збору та безпеки даних та висновками західних експертів та звітів, що викликає питання про прозорість та довіру  ([[#^comment-0|Comment Unknown Author 3]]). Наприклад, TikTok заявляє, що не збирає певні конфіденційні дані (такі як IMEI, серійний номер SIM-карти, MAC-адреси в поточних версіях)  ([[#^comment-0|Comment Unknown Author 12]]), але експертні звіти деталізують широкий збір даних  ([[#^comment-0|Comment Unknown Author 6]]). Компанія також визнала, що співробітники, які працюють у Китаї, отримували доступ до даних американських журналістів у 2022 році  ([[#^comment-0|Comment Unknown Author 3]]).
...
|---|---|---|
|Особиста інформація|Так  ([[#^comment-0\|Comment Unknown Author 6]])|Так  ([[#^comment-0\|Comment Unknown Author 11]])|
|---|---|---|
|Дані про місцезнаходження|Так  ([[#^comment-0\|Comment Unknown Author 3]])|Так  ([[#^comment-0\|Comment Unknown Author 11]])|
|---|---|---|
|Історія переглядів/пошуку|Так  ([[#^comment-0\|Comment Unknown Author 3]])|Так  ([[#^comment-0\|Comment Unknown Author 11]])|
|---|---|---|
|Патерни натискання клавіш|Так  ([[#^comment-0\|Comment Unknown Author 3]])|Потенційно  ([[#^comment-0\|Comment Unknown Author 3]])|
|---|---|---|
|Інформація про пристрій|Так  ([[#^comment-0\|Comment Unknown Author 6]])|Так  ([[#^comment-0\|Comment Unknown Author 11]])|
|---|---|---|
|Контакти|Так (за наявності дозволу)  ([[#^comment-0\|Comment Unknown Author 6]])|Так  ([[#^comment-0\|Comment Unknown Author 11]])|
|---|---|---|
|Біометричні дані|Потенційно  ([[#^comment-0\|Comment Unknown Author 11]])|Так  ([[#^comment-0\|Comment Unknown Author 11]])|
|---|---|---|
|Фінансова інформація|Так (якщо використовується для покупок)  ([[#^comment-0\|Comment Unknown Author 6]])|Так (якщо використовується для транзакцій)  ([[#^comment-0\|Comment Unknown Author 11]])|
|---|---|---|
|Взаємодія з контентом|Так  ([[#^comment-0\|Comment Unknown Author 6]])|Так  ([[#^comment-0\|Comment Unknown Author 11]])|
|---|---|---|
|Повідомлення|Так  ([[#^comment-0\|Comment Unknown Author 3]])|Так  ([[#^comment-0\|Comment Unknown Author 11]])|
|---|---|---|
|Аудіо/відео контент|Так  ([[#^comment-0\|Comment Unknown Author 6]])|Так  ([[#^comment-0\|Comment Unknown Author 11]])|
|---|---|---|
|Рівень заряду батареї, оператор тощо.|Так  ([[#^comment-0\|Comment Unknown Author 7]])|Потенційно|
|---|---|---|
